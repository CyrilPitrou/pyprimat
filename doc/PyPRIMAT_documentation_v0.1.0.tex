...
\title{\textbf{PyPRIMAT}\\[2pt]
       ...
       \normalsize\textit{Documentation for PyPRIMAT version 0.1.0}}
\author{Cyril Pitrou}
\date{\today}
...
\code{PyPRIMAT\_doc\_figures.ipynb}. This document describes \textbf{PyPRIMAT
version 0.1.0}; a forthcoming v0.2.0 is expected to introduce architectural
changes, after which this reference will be updated.
\end{abstract}
...
(and $\chi_+\to\chi_-$ for $p\to n$). PyPRIMAT supports two forms of
