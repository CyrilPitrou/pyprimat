...
int main(void)
{
    ...
    if (cpr_table_read("../pyprimat/rates/nuclear/tables/n_p__d_g/n_p__d_g_primat.txt",
                        3, &t, &err)) {
    ...
    if (cpr_table_read("../pyprimat/rates/NEVO/NEVOPRIMAT_col_1_7.csv", 0, &t, &err)) {
    ...
    if (cpr_table_read("../pyprimat/rates/NEVO/NEVOGrid.csv", 1, &t, &err)) {
    ...
    if (cpr_table_read("../pyprimat/rates/plasma/QED_P_int.txt", 3, &t, &err)) {
