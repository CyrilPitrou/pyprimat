...
int main(void)
{
    ...
    if (cpr_load_network_list("../pyprimat/rates/nuclear/networks/small.txt", &small, &err)) {
    ...
    if (cpr_load_network_list("../pyprimat/rates/nuclear/networks/large.txt", &large, &err)) {
    ...
    if (cpr_load_decays("../pyprimat/rates/nuclear/tables/decays.txt", &decays, &err)) {
    ...
    if (cpr_load_detailed_balance("../pyprimat/rates/nuclear/data/detailed_balance.csv", &db, &err)) {
    ...
    CPRReactionTable rx;
    if (cpr_load_reactions_large("../pyprimat/rates/nuclear/data/reactions_large.csv", &rx, &err)) {
